var NemoCV = {
    ...
    drawSkillsArc: function() {
        ...
        function c(t, r) {
            r.node["on" + t] = function() {
                for (var v = 0, u = r.events.length; v < u; v++) {
            ...
            for (var u = 0; u < j.length; u++) {
                ...
                (function(z, A, B) {
                    ...
                    w.mouseover(function() {
                        ...
                        var H = this.node.id;
                        for (var C = 0, F = l[H]; C < F.length; C++) {
                            var D = i + 10;
    ...
    drawExperienceTimeLine: function() {
        ...
        var e = [
            [200, 25, "#97BE0D", "2009.09 - 2013.07，广东，广州", "计算机专业 本科 (华南理工大学)", ""],
            [300, 20, "#88B8E6", "2009.10 - 2011.06", "南校B7计算机中心", "助理"],
            [400, 10, "#88B8E6", "2011.07 - 2012.02", "广州赛麟信息技术有限公司", "兼职网站开发，负责公司网站建设和维护"],
            [500, 10, "#88B8E6", "2012.07 - 2013.02", "广州一刻影像科技有限公司", "Web前台开发，负责一刻网（ikefoto.com）维护和重构、改版工作"],
            [600, 20, "#989898", "Next", "?", ""]
        ];
        var d = [
            ["#97BE0D", 400, "学习"],
    ...
    drawProjectsGallery: function() {
        ...
        var e = ["project_ike.png", "project_imettoimage.png", "project_yuyue.png", "project_acechics.jpg", "project_circle_sina.png", "project_tinna_audio_ebay_store.png", "project_aizuoye.png"];
